...
function GM:DrawPlayerInformation()
	...
	text[#text+1] = {arista.lang:Get"AL_HUD_SALARY" .. string.Comma(ply:getSalary()), "icon16/folder_go"}
	text[#text+1] = {arista.lang:Get"AL_HUD_MONEY" .. string.Comma(ply:getMoney()), "icon16/star"}
